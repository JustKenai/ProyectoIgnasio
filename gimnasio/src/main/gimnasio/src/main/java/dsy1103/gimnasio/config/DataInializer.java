...
public class DataInializer implements CommandLineRunner{
    ...
    public void run(String... args) {
        ...
        Notificacion notificacion1 = notificacionRepository.save(
                new Notificacion(null,"Plan a punto de terminar.Realizar pago antes de vencer")
        );
        ...
        Socio socio1 = socioRepository.save(
                new Socio(null,"Marcelo Ignacio","Antiguay Araya","22.185.379-2",974064520, LocalDate.of(2006,8,10),plan1,null)
