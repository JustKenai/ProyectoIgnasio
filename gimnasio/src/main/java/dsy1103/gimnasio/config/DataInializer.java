...
public class DataInializer implements CommandLineRunner{
    ...
    public void run(String... args) {
        ...
        PlanSuscripcion planBasico = planSuscripcionRepository.save(
                    new PlanSuscripcion(null, "Plan Básico", "✅ Uso de sala de máquinas ✅ Peso libre ✅ Clases grupales básicas.", 140000.0, 30));

        PlanSuscripcion planBlack = planSuscripcionRepository.save(
                new PlanSuscripcion(null, "Plan Black", "✅ Posibilidad de llevar a un amigo ✅ Acceso a áreas de relax.✅ Incluye todo lo del Plan Básico", 17450.0,30));

        PlanSuscripcion planCorporativo = planSuscripcionRepository.save(
                new PlanSuscripcion(null, "Plan Corporativo", "✅ Se ofrece como beneficio laboral a empleados de empresas asociadas. ✅ Más todo lo del Plan Básico", 26900.0,30));
        ...
        Socio socio2 = socioRepository.save(
                new Socio(null,"Joaquin Antonio","Canales Sepulvea","19.542.230-k",998237634, LocalDate.of(2003,2,3),planBlack,notificacionNavidad));
